...
import { createFacturas } from "../graphql/mutations";
...
export default function FacturasCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setDetalle_array(initialValues.detalle_array);
    setCurrentDetalle_arrayValue("");
    setDetalle_normal(initialValues.detalle_normal);
    setErrors({});
  };
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createFacturas.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "FacturasCreateForm")}
      {...rest}
    >
      <TextField
        label="Numero"
